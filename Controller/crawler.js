...
exports.index = async function(req, res) {
    ...
    (async () => {
        ...
        if(status_tempat == "exist"){
            ...
            await page.waitForSelector( '#pane > div > div.widget-pane-content.scrollable-y > div > div > div.section-layout.section-layout-justify-space-between.section-layout-vertically-center-content.section-layout-flex-vertical.section-layout-flex-horizontal > div.iRxY3GoUYUY__actionicon > div > button' );
            ...
            request({
                ...
                const finalData = new final_data({
...
async function getCoordinat(place){
    ...
    var options = {
        uri: "https://maps.googleapis.com/maps/api/geocode/json?address="+place+"&key="+key,
        method: "GET",
        json: true
    }
